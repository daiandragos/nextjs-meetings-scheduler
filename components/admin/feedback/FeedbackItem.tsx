...
export function FeedbackItem({
  ...
  return (
    <div
      className={`group relative flex gap-3 p-3 rounded-xl border transition-all duration-200 hover:shadow-sm ${archived ? "bg-zinc-50 border-zinc-200/60 opacity-70" : "bg-white border-zinc-200/60 hover:border-amber-200"}`}
    >
      ...
      <Button
        ...
        className={`shrink-0 size-8 opacity-50 hover:opacity-100 transition-opacity ${
          archived
