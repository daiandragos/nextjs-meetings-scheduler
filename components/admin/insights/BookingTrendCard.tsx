...
export function BookingTrendCard() {
  ...
  return (
    <Card className="relative overflow-hidden bg-linear-to-br from-amber-500 via-amber-500 to-orange-500 border-0 shadow-amber-500/25 shadow-lg">
      ...
      <CardContent className="relative">
        <div className="flex items-end gap-4">
          ...
          <div className="flex flex-col pb-2">
            ...
            >
              <div
                className={`flex items-center justify-center size--5 rounded-full ${isPositive ? "bg-emerald-400/30" : isNegative ? "bg-red-400/30" : "bg-white/20"}`}
              >
