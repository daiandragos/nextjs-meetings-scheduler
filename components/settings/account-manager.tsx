    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Connect Google Calendar to sync busy times and create meetings.
          </p>
          {!isUnlimited && (
      ...
      <div className="rounded-lg bg-muted/50 p-4">
        ...
        <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
          <li> - Your busy times are shown on your availabilty page</li>
          <li>
            {" "}
            - When someone books a meeting, an event is created on your main
            calendar
          </li>
          <li>
            - Both you and the guest receive confirmation email invitations from
            Google
          </li>
        </ul>
      </div>
