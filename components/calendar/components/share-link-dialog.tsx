...
import type { MeetingDuration } from "@/lib/actions/availability";
import { BookingQuotaStatus } from "@/lib/features";
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-6 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-amber-700">
                  ...
                  share the booking link with others.
                </p>
              </div>
            ...
            {isPending && !selectedMeetingType && !isCreatingType ? (
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    id="meeting-name"
                    placeholder="e.g. Quick chat, Meeting"
                    value={newTypeName}
