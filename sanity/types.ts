...
export type AllSanitySchemaTypes = Feedback | ConnectedAccount | Booking | MeetingType | Slug | User | AvailabilitySlot | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[\n        _type == \"user\" && clerkId == $clerkId\n    ][0]{\n        _id,\n        availability[]{\n            _key,\n            startDateTime,\n            endDateTime\n        }\n    }": USER_WITH_AVAILABILTY_QUERYResult;
